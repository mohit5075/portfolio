      ...
      >
        <nav className="section-container flex items-center justify-between h-16 sm:h-18">
          ...
          <div className="flex items-center gap-2">
            ...
            <a href="https://drive.google.com/file/d/1OpM2XL5vK5M-eNhxfNR1siMs23KMO9pk/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="hidden sm:inline-flex btn-primary !py-2 !px-4 !text-xs">
              <Download size={14} />
              Resume
            </a>
            <button
        ...
        {mobileOpen && (
          ...
          >
            <nav className="section-container flex flex-col gap-2 pt-4">
              ...
              <a
                href="https://drive.google.com/file/d/1OpM2XL5vK5M-eNhxfNR1siMs23KMO9pk/view?usp=sharing"
                target="_blank"
                rel="noopener noreferrer"
